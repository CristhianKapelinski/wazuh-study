...
## Sintaxe (apenas a especificação técnica)

IDs ≥ 100000. Encadear via <if_sid> ou <if_matched_sid>. Correlação usa frequency/timeframe e modificadores como <same_srcip/>, <same_user/>. Faixas de IP em <srcip>. Negação com !.
